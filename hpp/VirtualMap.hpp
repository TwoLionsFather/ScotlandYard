...
namespace tlk
{
    ...
    public:
        ...
        bool gameIsWonByMRX();  //TODO Move to Game instead

        std::vector<unsigned int> getAllPossibleLocationsForMrx();
        std::vector<unsigned int> getAllPossibleLocationsForMrx(Connection simulatedMove);
    ...
    private:
        ...
        std::vector<tlk::ConnectionType, unsigned int> mrx_publicHistory;
